...
`ascairn` (alpha-satellite cairn) is software for estimating centromere variation from short-read sequencing data using rare k-mers within centromere sequences, even at coverage as low as 1x.
...
This repository contains the reference data required by ascairn, including:
   ...
   - Per-chromosome HOR cluster summaries (`cluster_summary/`)
...
ascairn somatic_cna \
    ...
    --hap_info chr{N}.hap_info.txt \  # optional; adds the aHOR-HG to plot titles
    -o output_prefix
```
...
| Haplotype_1 | Nearest haplotype ID for the first allele (e.g., `HG00268.h1`) |
...
<div align="center">
  <img src="https://raw.githubusercontent.com/friend1ws/ascairn/main/image/cluster_match.heatmap.labeled.hg38.v040.png" alt="Accuracy on GRCh38-aligned data" width="750">
</div>

**CHM13-aligned data:**

<div align="center">
  <img src="https://raw.githubusercontent.com/friend1ws/ascairn/main/image/cluster_match.heatmap.labeled.chm13.v040.png" alt="Accuracy on CHM13-aligned data" width="750">
</div>

Accuracy is generally high (>90%) for most chromosomes even at 1x coverage, with slightly better performance for GRCh38-aligned data compared to CHM13. The probabilistic model has since been refined beyond the original publication, further improving accuracy especially at low coverage. See [Shiraishi et al., bioRxiv, 2025](https://doi.org/10.1101/2025.07.26.666712) for experimental details.
