...
@click.option("--exhaustive", is_flag=True, default=False, help="Use exhaustive full search instead of the default beam search.")
@click.option("--beam_K", default=3, hidden=True)
